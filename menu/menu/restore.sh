...
if ! rclone copy dr:pass/$id.txt /root/ &>/dev/null; then
    echo "Gagal mengunduh password dari Google Drive, mencoba ekstraksi tanpa password..."
...
systemctl restart xray ws dropbear
